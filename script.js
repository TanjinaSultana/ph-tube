            ...
            const hrs = Math.floor(sec / 3600); 
             const mins = Math.floor((sec % 3600) / 60);
                    ...
                    <div class="card-body items-center text-center">
                      ...
                      <p class="text-neutral-600 text-base font-normal"> ${category?.authors[0]?.profile_name}</p>
                  ...
                  <p class="text-neutral-600 text-base font-normal">${category.others.views} views</p>  
                    </div>
                  </div>`;
